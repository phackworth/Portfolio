...
function whoWon() {
    ...
    if (dieSum <= 5){
      balance -= 5;
      outcome = "You lose, please pay me " + 5 + " dollars. Your balance is " + balance + " dollars.";
      
    } else if (dieSum >= 9){
      balance += 5;
      outcome = "You win, I pay you " + 5 + " dollars. Your balance is " + balance + " dollars.";
      
    } else {
      outcome = "Its a draw, nobody wins or loses. Your balance is " + balance + " dollars.";
    }
...
function letsPlay(){
  var numFun = document.getElementById("numRoll").value;
  if(numFun > 0)
  {
